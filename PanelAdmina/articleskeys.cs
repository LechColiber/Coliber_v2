...
{
    public partial class ArticlesKeys : Form
    {
        ...
        public ArticlesKeys(Connection NewConnection, string Caption, string SelectedTable)
        {
            InitializeComponent();
        ...
        private void SelectFromDb(int id_rodzaj)
        {
            try
            {
                ...
                //dataGridView1.Columns["id_rodzaj"].HeaderText = _T("kind");
        ...
        private void ShowBooksButton_Click(object sender, EventArgs e)
        {
            ...
            {
                ShowList ShowListForm = new ShowList(GetListWhereKeyOccured(Int32.Parse(dataGridView1["Kody", dataGridView1.CurrentRow.Index].Value.ToString())), _T("for") + " " + dataGridView1["Klucze", dataGridView1.CurrentRow.Index].Value.ToString());
        ...
        private List<string> GetListWhereKeyOccured(int IDKey)
        {
            try
            {
                ...
                Command.CommandText = "SELECT LTRIM(RTRIM(tytul)) AS tytul " +
                                        "FROM dbo.artykuly " +
                                        "LEFT JOIN dbo.art_klu ON artykuly.kod = art_klu.kod " +
                                        "LEFT JOIN dbo.klucze_a ON klucze_a.kody = art_klu.kody " +
                                        "WHERE klucze_a.kody = ? " +
                                        "ORDER BY tytul; ";
        ...
        private void AddButton_Click(object sender, EventArgs e)
        {
            ...
            {
                EditKeysForm EKF = new EditKeysForm(NewConnection, ReturnIDRodzaj(RodzajDataTable), 1, "", -1, 'a');
                EKF.ShowDialog();
                SelectFromDb(ReturnIDRodzaj(RodzajDataTable));
            }
        }
            ...
            else if (MergeButton.Text == _T("merge") && dataGridView1.Rows.Count > 0)
            {
                try
                {
                    ...
                    if (ChSForm.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                    {
                        ...
                        if (MessageBox.Show(_T("merge_q") + "\"" + dataGridView1["Klucze", dataGridView1.CurrentRow.Index].Value.ToString() + "\"" +_T("with") + "\"" + dataGridView1["Klucze", Row].Value.ToString() + "\"?", _T("data_merge"), MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                        {
        ...
        private void DelButton_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.Rows.Count > 0)
            {
                ...
                {
                    if (MessageBox.Show(_T("show_res_q") + " " + dataGridView1["Klucze", dataGridView1.CurrentRow.Index].Value.ToString() + "?", _T("show_res"), MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
                    {
                ...
                //MessageBox.Show(_T("to_delete") + " " + dataGridView1["Klucze", dataGridView1.CurrentRow.Index].Value.ToString() + " ?", _T("db_deleting"), MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)

                if (MessageBox.Show(_T("to_delete") + " " + _T("keyword").ToLower() + " ?", _T("db_deleting"), MessageBoxButtons.YesNo, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)
                {
        ...
        private void PrintButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ShowReport Report = new ShowReport(ReportCommand, "ArticlesKeysReport");
        ...
        // OK
        private void ArticlesKeys_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void EditButton_Click(object sender, EventArgs e)
        {
            ...
            if (dataGridView1.CurrentRow != null)
            {
                ...
                EditKeysForm EKF = new EditKeysForm(NewConnection, Int32.Parse(dataGridView1.CurrentRow.Cells["id_rodzaj"].Value.ToString()), 2, dataGridView1.CurrentRow.Cells["Klucze"].Value.ToString(), Int32.Parse(dataGridView1.CurrentRow.Cells["Kody"].Value.ToString()), 'a');
                EKF.ShowDialog();
