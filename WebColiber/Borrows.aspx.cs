                    ...
                    using(SqlDataReader reader = cmd.ExecuteReader())
                    {
                        if (reader.HasRows)
                        {
                            ...
                            ResultsNR.Text += "<tr>" + 
                                                ...
                                                "<th style='padding-left: 10px; padding-right: 10px; min-width: 170px; max-width: 170px;'>" + Language.signature + "</th>" +
                                                "<th style='padding-left: 10px; padding-right: 10px; min-width: 170px; max-width: 1700px;'>" + Language.description + "</th>" +
                                            "</tr>";
                            ...
                            while (reader.Read())
                            {
                                ...
                                ResultsNR.Text += "<td style='padding-left: 10px; padding-right: 10px; min-width: 170px; max-width: 170px;'>" + reader.GetValue("syg").ToString() + "</td>";
                                ResultsNR.Text += "<td style='padding-left: 10px; padding-right: 10px; min-width: 170px; max-width: 1700px;'>" + reader.GetValue("opis").ToString() + "</td>";
                    ...
                    using(SqlDataReader reader = cmd.ExecuteReader())
                    {
                        if (reader.HasRows)
                        {
                            ...
                            while (reader.Read())
                            {
                                ...
                                ResultsR.Text += "<td style='padding-left: 10px; padding-right: 10px; min-width: 170px; max-width: 170px'>" + reader.GetValue(4).ToString() + "</td>";
