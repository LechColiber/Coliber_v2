...
namespace WebColiber
{
    public partial class OrderSent : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            List<string> OrdersIdZasobNor = null;
            ...
            if (Session["ordersIdZasobNor"] != null && Session["ordersIdZasobNor"] as string != "")
                OrdersIdZasob = new List<string>((Session["ordersIdZasobNor"] as string).Split(','));

            Session["ordersIdZasob"] = null;
            Session["ordersIdZasobNor"] = null;

            if ((OrdersIdZasob != null && OrdersIdZasob.Count > 0) || (OrdersIdZasobNor != null && OrdersIdZasobNor.Count > 0))
            {
