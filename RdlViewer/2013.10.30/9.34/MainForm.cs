...
namespace RdlViewer
{
    public partial class MainForm : Form
    {
        ...
        public MainForm(string ReportName, ReportParameter[] Parameters, string Mode, string ConnectionString)
            : this()
        {
        ...
        {
            ReportParameter R = new ReportParameter("nr_zam", "152/13");
            Parameters = new ReportParameter[1];
            Parameters[0] = R;

            OpenReport("Wypozyczenie.rdl");
        }
